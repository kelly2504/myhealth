...
public class FileManager {
	...
	public void SaveRecordToFile(List<HealthRecord> records) throws NullPointerException {
		...
		try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
			...
			for (HealthRecord record : records) {
				...
				writer.newLine();
				writer.write("Temperature   : " + record.getTemperature() + " °C");
				writer.newLine();
				writer.write("Blood pressure: " + record.getBloodPressure() + " mmHg");
				writer.newLine();
	...
	public void SaveRecordToFile(HealthRecord record) throws NullPointerException{
		...
		try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
			...
			writer.write("Temperature   : " + record.getTemperature() + " °C");
			writer.newLine();
			writer.write("Blood pressure: " + record.getSystolic() + "/" + record.getDiastolic() + " mmHg");
			writer.newLine();
			writer.write("Note          : " + record.getNote());
			writer.newLine();
			writer.close();
